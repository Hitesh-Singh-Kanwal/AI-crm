...
export const REPORT_CATALOG = [
  ...
  },
  {
    ...
    description: 'Lessons, active students, revenue, conversions, retention, and averages by teacher.',
    category: 'Teachers',
    keywords: ['teacher', 'performance', 'retention', 'revenue', 'lessons'],
  ...
  },
  {
    ...
    description: 'Class attendance with payment source and paid/unpaid status.',
    category: 'Students',
