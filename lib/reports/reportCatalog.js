...
export const REPORT_CATALOG = [
  ...
  {
    slug: 'tip-pool',
    title: 'Tip Pool Report',
    description: 'Tips collected into the shared pool, excluded from teacher commissions.',
    category: 'Sales',
    keywords: ['tip', 'tips', 'pool', 'gratuity', 'payout'],
    href: '/reports/tip-pool',
  ...
  },
  {
    ...
    description: 'Lead pipeline from created through engaged, pending payment, and converted.',
    category: 'Leads',
