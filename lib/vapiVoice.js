...
export const VAPI_TTS_OPTION_GROUPS = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        price: '$50',
        description:
          'Retired from the arena. Turbo v2.5 arrived in July 2024 and extended ElevenLabs’ low latency tier from English to 32 languages. In Vapi’s 50-trial streaming benchmark it returned first audio in a median of 265 ms. Price / 1M chars $50. Humanness is unpublished.',
      },
      {
        value: 'hume:octave2',
        provider: 'hume',
        ...
        languages: '—',
        price: '—',
        description: 'Not listed on Vapi’s Humanness Index™.',
      },
    ],
  },
]
