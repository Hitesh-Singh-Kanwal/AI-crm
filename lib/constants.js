...
export const ROUTE_PERMISSIONS = {
  ...
  '/inbox/calls': { category: 'inbox', module: 'HumanQueue' },
  '/inbox/human-queue': { category: 'inbox', module: 'HumanQueue' },
  '/inbox/talk-to-assistant': { category: 'inbox', module: 'AllMessages' },
  '/settings': { category: 'settings', module: 'locations' },
