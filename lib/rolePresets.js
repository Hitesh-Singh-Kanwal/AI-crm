...
const RW = { read: true, write: true, edit: true, delete: false, scope: 'all' }
const RWD = { read: true, write: true, edit: true, delete: true, scope: 'all' }
const R = { read: true, write: false, edit: false, delete: false, scope: 'all' }
const OWN_RW = { read: true, write: true, edit: true, delete: false, scope: 'own' }
const OWN_R = { read: true, write: false, edit: false, delete: false, scope: 'own' }
