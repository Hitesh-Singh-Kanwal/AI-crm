...
export function shouldShowSourceFilter(list, filters) {
  ...
  if (operator === 'eq' && uploadType === FORM_SUBMISSION_UPLOAD_TYPE) return true
  if (operator === 'in' && Array.isArray(uploadType) && uploadType.includes(FORM_SUBMISSION_UPLOAD_TYPE)) {
    return true
  }
