 ...
 * phone; © year · All rights reserved). No unsubscribe.
 */
...
/** Plain-text preview (matches injected design; no unsubscribe). */
 ...
 * dark bar, centered light text, middle-dot separators, copyright.
 * No unsubscribe / manage preferences.
 */
export function buildLocationFooterBlockHtml(loc) {
  ...
  // Table layout for email-client reliability; dark full-width bar at the end.
  return (
