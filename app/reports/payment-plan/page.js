...
function PaymentPlanReportPageContent() {
...
export default function PaymentPlanReportPage() {
  return (
    <ReportPageSuspense title="Payment Plan Report" subtitle="Active installment plans and due dates">
      <PaymentPlanReportPageContent />
    </ReportPageSuspense>
  )
}
