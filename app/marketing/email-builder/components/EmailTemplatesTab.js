...
export default function EmailTemplatesTab({ onCreateNew, dataVersion = 0, onDataChanged }) {
  ...
  // Reset to page 1 when filters/category change (during render so effects don't fetch the old page)
  ...
  // Keep selected category in sync when categories refresh (e.g. after rename/delete)
  useEffect(() => {
